...
# valid_loss_min = -1e9 # track change in validation loss
accuracy = []
lr = 0.1
counter = 0
for epoch in tqdm(range(1, n_epochs+1)):
    ...
    if valid_loss <= valid_loss_min:
        ...
        torch.save(model.state_dict(), 'AIRecode/resnet18_on_imbalanced_dataset/checkpoint/resnet18_cifar10_imbalance_originloss.pt')
