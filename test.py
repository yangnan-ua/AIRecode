...
# 载入权重
model.load_state_dict(torch.load('/mnt/home/xuhan1/yangnan/AIRecode/resnet18_on_imbalanced_dataset/checkpoint/resnet18_cifar10_balance.pt'))
...
# 打印每个类别的准确率
classes = ('plane', 'car', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'truck')  # CIFAR-10 类别名称
